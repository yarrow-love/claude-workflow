...
| # | Phase | Gist | Status |
| --- | --- | --- | --- |
| 1 | [mechanics](1.mechanics.md) | Depth-cap env key + BASELINE + `/initialize` audit; `session-archive` subagent sweep with self-test; operator-gated interactive-default check | pending |
