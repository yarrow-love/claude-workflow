...
2. **MCP servers** — `claude mcp list` shows the always-useful set: `context7`, `playwright`, `chrome-devtools`. Missing → report with the exact add-command from BASELINE.md.
